...
import com.amazonaws.ivs.player.scrollablefeed.databinding.StreamTitleViewBinding
...
import kotlinx.android.synthetic.main.stream_title_view.*
...
class MainActivity : AppCompatActivity() {
    ...
    private fun openDonation(view: TextView) {
        setContentView(R.layout.stream_title_view)
    }
